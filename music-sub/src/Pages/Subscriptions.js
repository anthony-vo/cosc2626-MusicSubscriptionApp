...
import { Navbar, Container, Nav, Card, Button, Row, Spinner } from "react-bootstrap";
...
const Subscriptions = () => {
  ...
  const [loading, setLoading] = useState(true); // Loading state to handle the loading process
  ...
  // If loading, show a loading spinner with background and keep Navbar/Sidebar visible
  if (loading) {
    return (
        <div
